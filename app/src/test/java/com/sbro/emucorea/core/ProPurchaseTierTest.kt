...
class ProPurchaseTierTest {
    ...
    fun productIds_matchPlayConsoleConfiguration() {
        assertEquals("emucorea_pro", ProPurchaseTier.BASE.productId)
        assertEquals("emucorea_pro_supporter", ProPurchaseTier.SUPPORTER.productId)
        assertEquals("emucorea_pro_patron", ProPurchaseTier.PATRON.productId)
    ...
    fun fromProductId_recognizesEveryProTier() {
        ...
        assertNull(ProPurchaseTier.fromProductId("emucorea_pro_supporte"))
