  ...
  public void onStart() {
    ...
    try {
      Class<?> factory = getTargetContext().getClassLoader().loadClass(
          "com.sbro.emucorea.core.SaveStatePreviewKt");
      ...
      c = getTargetContext().getClassLoader().loadClass("com.sbro.emucorea.core.NativeCoreBridge");
      ...
      sc = getTargetContext().getClassLoader().loadClass("com.sbro.emucorea.core.PspStorageBridge");
      ...
      Uri fixtureTree =
          DocumentsContract.buildTreeDocumentUri("com.sbro.emucorea.probe.files", "root");
      getTargetContext().getContentResolver().call(
          Uri.parse("content://com.sbro.emucorea.probe.files"), "grant", null, null);
      ...
      int initialReads =
          getTargetContext()
              .getContentResolver()
              .call(Uri.parse("content://com.sbro.emucorea.probe.files"), "report", null, null)
              .getInt("dataReads");
