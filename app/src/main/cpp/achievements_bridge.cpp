...
{
  info->data = static_cast<uint8_t*>(EmuCoreAGetMemoryData(id));
  info->size = (info->data != nullptr) ? EmuCoreAGetMemorySize(id) : 0;
}
...
extern "C" void EmuCoreAAchievementsInitializeJava(JNIEnv* env)
{
  ...
  jclass response_class = env->FindClass("com/sbro/emucorea/core/AchievementsHttpResponse");
  ...
  jclass http_class = env->FindClass("com/sbro/emucorea/core/AchievementsHttp");
  ...
  g_http_request_method = env->GetStaticMethodID(
    ...
    "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sbro/emucorea/core/AchievementsHttpResponse;");
}
...
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsSetEnabled(JNIEnv*, jobject, jboolean enabled)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsSetHardcore(JNIEnv*, jobject, jboolean enabled)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsSetUnofficial(JNIEnv*, jobject, jboolean enabled)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsSetEncore(JNIEnv*, jobject, jboolean enabled)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
...
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsLoginWithPassword(JNIEnv* env, jobject thiz, jstring user,
                                                                           jstring password)
{
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsLoginWithToken(JNIEnv* env, jobject thiz, jstring user,
                                                                        jstring token)
{
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsLogout(JNIEnv*, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  if (g_state.client != nullptr)
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsLoadGame(JNIEnv* env, jobject, jstring path)
{
  if (path == nullptr)
    return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsUnloadGame(JNIEnv*, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  g_state.has_game.store(false, std::memory_order_relaxed);
  if (g_state.client != nullptr)
...
extern "C" JNIEXPORT void JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsPump(JNIEnv*, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  PumpHttpResponsesLocked();
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsStateJson(JNIEnv* env, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  PumpHttpResponsesLocked();
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsAchievementsJson(JNIEnv* env, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  if (g_state.client == nullptr)
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_sbro_emucorea_core_NativeCoreBridge_achievementsPollEventsJson(JNIEnv* env, jobject)
{
  std::lock_guard<std::recursive_mutex> lock(g_state.mutex);
  PumpHttpResponsesLocked();
