...
import com.sbro.emucorea.core.AppLocaleManager
import com.sbro.emucorea.core.GamepadManager
import com.sbro.emucorea.core.NativeApp
import com.sbro.emucorea.core.PlayInAppReviewManager
...
import com.sbro.emucorea.navigation.AppNavigation
import com.sbro.emucorea.ui.common.GamepadUiInputRouter
import com.sbro.emucorea.ui.theme.EmuCoreATheme
...
open class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (preferences.getProUnlockedSync()) {
            setTheme(R.style.Theme_EmuCoreA_Splash_Pro)
        }
    ...
    private fun recordCompletedEmulationSession(
        ...
        val app = application as EmuCoreAApp
        ...
        PlayInAppReviewManager.request(this) { result ->
            ...
            when (result) {
                PlayInAppReviewManager.Result.COMPLETED -> {
                    (application as EmuCoreAApp).applicationScope.launch {
