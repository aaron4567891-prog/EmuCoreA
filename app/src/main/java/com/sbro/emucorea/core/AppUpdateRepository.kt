...
class AppUpdateRepository(private val context: Context) {
    ...
    private fun openConnection(): HttpURLConnection {
        return (URL(RELEASES_URL).openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "EmuCoreA/${currentVersionName()}")
        }
    }
    ...
    companion object {
        private const val RELEASES_URL = "https://api.github.com/repos/sashkinbro/EmuCoreA/releases?per_page=100"
    }
}
