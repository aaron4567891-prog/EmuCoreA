...
import com.sbro.emucorea.data.TexturePackInfo
import com.sbro.emucorea.data.TexturePackRepository
import com.sbro.emucorea.data.TexturePackSummary
            ...
            val result = try {
                withContext(Dispatchers.IO) {
                    runCatching { repository.importPackZip(uri) }
                        .getOrElse { com.sbro.emucorea.data.TextureImportResult(success = false) }
                }
            } finally {
                isWorking = false
            }
