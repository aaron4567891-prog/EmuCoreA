...
import com.sbro.emucorea.data.drive.DriveBackupEntry
import com.sbro.emucorea.data.drive.DriveOperation
        ...
        AlertDialog(onDismissRequest = { restore = null }, title = { Text(stringResource(R.string.drive_restore)) },
            text = {
                Column(Modifier.verticalScroll(rememberScrollState())) {
                    ...
                    listOf("settings" to R.string.drive_category_settings, "memory-stick" to R.string.drive_category_memory_stick,
                        "memory-cards" to R.string.drive_category_cards,
