package com.sbro.emucorea.feedback
...
class FeedbackUploadWorker(
    ...
    private fun upload(directory: File, feedback: QueuedFeedback): Int {
        ...
        val boundary = "EmuCoreA-${UUID.randomUUID()}"
        val connection = (endpoint.openConnection() as HttpURLConnection).apply {
            ...
            // The shared EmuCoreA feedback worker authenticates with X-EmuCoreAX-Key.
            setRequestProperty("X-EmuCoreAX-Key", BuildConfig.FEEDBACK_API_KEY)
            setRequestProperty("User-Agent", "EmuCoreA/${BuildConfig.VERSION_NAME} (Android)")
        }
