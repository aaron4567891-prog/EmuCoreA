 ...
 * PlayStation Portable metadata bundled with PPSSPP and IGDB.
 */
class PspTitleIndexRepository(context: Context) {
    ...
    private fun serialSortKey(serial: String): Char {
        ...
        return when {
            compact.startsWith("ULUS") || compact.startsWith("UCUS") || compact.startsWith("NPUH") -> 'U'
            compact.startsWith("ULES") || compact.startsWith("UCES") || compact.startsWith("NPEH") -> 'E'
            compact.startsWith("ULJS") || compact.startsWith("ULJM") || compact.startsWith("UCJS") ||
                compact.startsWith("NPJH") -> 'J'
            else -> '?'
        }
    }
    ...
    private companion object {
        private const val ASSET_PATH = "catalog/psp_titles.json"
